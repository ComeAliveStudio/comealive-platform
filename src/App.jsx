...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-bg {
    ...
    background:
      radial-gradient(ellipse 60% 50% at 70% 50%, rgba(184,149,90,0.06) 0%, transparent 70%),
      linear-gradient(160deg, #0e0d0b 0%, #1a1713 50%, #0e0d0b 100%);
  }
  .hero-grain {
  ...
  .hero-sub {
    font-size: 1rem; color: var(--mist); max-width: 480px;
  ...
  .hero-scroll::before {
    content: ''; display: block; width: 1px; height: 40px; background: var(--mist);
  ...
  h2 {
    ...
    color: var(--parchment); line-height: 1.15; margin-bottom: 1.2rem;
  }
  ...
  .about-portrait-inner {
    ...
    background: linear-gradient(160deg, #2a2825 0%, #1a1713 100%);
  ...
  .tier-card.featured {
    border-color: var(--gold); background: #1e1c18;
  }
  ...
  .tier-price {
    ...
    color: var(--gold); font-weight: 300; line-height: 1; margin: 1rem 0 0.3rem;
  }
  ...
  .tier-features li {
    font-size: 0.83rem; color: var(--mist); padding: 0.5rem 0;
  ...
  .course-tab {
    padding: 0.8rem 1.8rem; background: none; border: none;
    font-family: 'Outfit', sans-serif; font-size: 0.75rem;
    letter-spacing: 0.1em; text-transform: uppercase; cursor: pointer;
    color: var(--mist); border-bottom: 2px solid transparent;
  ...
  .video-thumb {
    aspect-ratio: 16/9;
    background: linear-gradient(135deg, #1a1713 0%, #2a2825 100%);
    display: flex; align-items: center; justify-content: center;
    position: relative; overflow: hidden;
  }
  .video-thumb-icon {
    width: 44px; height: 44px; border-radius: 50%;
    background: rgba(184,149,90,0.15); border: 1px solid var(--gold);
    display: flex; align-items: center; justify-content: center;
    color: var(--gold); font-size: 1rem;
  }
  .video-lock {
    position: absolute; top: 0.8rem; right: 0.8rem;
    background: rgba(14,13,11,0.8); padding: 0.3rem 0.6rem;
    font-size: 0.6rem; letter-spacing: 0.12em; text-transform: uppercase;
    color: var(--mist); border: 1px solid var(--border);
    font-family: 'DM Mono', monospace;
  }
  .video-free {
    background: rgba(184,149,90,0.15); color: var(--gold); border-color: var(--gold-dim);
  }
  .video-info { padding: 1.2rem; }
  .video-duration {
    font-family: 'DM Mono', monospace; font-size: 0.62rem;
    color: var(--mist); letter-spacing: 0.1em; margin-bottom: 0.4rem;
  }
  .video-title {
    font-family: 'Cormorant Garamond', serif; font-size: 1.1rem;
    color: var(--parchment); line-height: 1.3; margin-bottom: 0.4rem;
  }
  ...
  .session-type {
    border: 1px solid var(--border); padding: 1.5rem; cursor: pointer;
    transition: all 0.2s; background: var(--ink);
  }
  ...
  .session-desc { font-size: 0.8rem; color: var(--mist); margin-top: 0.5rem; }
  .booking-form { display: flex; flex-direction: column; gap: 1rem; }
  .form-group { display: flex; flex-direction: column; gap: 0.4rem; }
  .form-label {
    font-size: 0.68rem; letter-spacing: 0.15em; text-transform: uppercase;
    color: var(--mist); font-family: 'DM Mono', monospace;
  }
  .form-input, .form-select, .form-textarea {
    background: var(--ink); border: 1px solid var(--border);
    color: var(--parchment); padding: 0.75rem 1rem;
    font-family: 'Outfit', sans-serif; font-size: 0.88rem;
    font-weight: 300; transition: border-color 0.2s; width: 100%;
  }
  ...
  .contact-grid {
    ...
    max-width: 950px; margin: 2rem auto 0; align-items: start;
  }
  ...
  .dash-header {
    ...
    background: var(--slate); display: flex; justify-content: space-between; align-items: center;
  }
  .dash-welcome {
  ...
  .dash-grid {
    display: grid; grid-template-columns: 260px 1fr; min-height: calc(100vh - 5rem);
  }
  .dash-sidebar {
    background: var(--slate); border-right: 1px solid var(--border); padding: 2rem 0;
  }
  .dash-nav-item {
    display: flex; align-items: center; gap: 0.8rem;
    padding: 0.9rem 1.8rem; cursor: pointer; transition: all 0.15s;
    font-size: 0.8rem; letter-spacing: 0.08em; color: var(--mist);
  ...
  .dash-card {
    background: var(--slate); border: 1px solid var(--border); padding: 1.8rem;
  }
  .dash-card-label {
    font-family: 'DM Mono', monospace; font-size: 0.62rem;
    letter-spacing: 0.15em; text-transform: uppercase; color: var(--mist); margin-bottom: 0.8rem;
  }
  .dash-card-value {
  ...
  .progress-bar {
    height: 3px; background: var(--border); margin-top: 1rem; border-radius: 2px;
  }
  .progress-fill {
    height: 100%; background: var(--gold); border-radius: 2px; transition: width 0.6s ease;
  }

  /* FOOTER */
  footer {
    padding: 3rem; background: var(--slate);
  ...
  /* UTILS */
  .stripe-note {
    background: rgba(184,149,90,0.06); border: 1px solid var(--border);
    padding: 1rem 1.5rem; margin-top: 1.5rem;
    font-family: 'DM Mono', monospace; font-size: 0.68rem;
    color: var(--mist); letter-spacing: 0.05em; line-height: 1.7;
  }
  .stripe-note strong { color: var(--gold); }
  ...
  @media (max-width: 768px) {
    ...
    .about-grid, .booking-grid, .contact-grid, .tiers-grid,
...
const courses = {
  "Filmmaking": [
    { id:1, title:"The Myth of the Budget", duration:"18 min", free:true,  desc:"Why money is the wrong first question, and what to ask instead." },
    { id:2, title:"Hire for Attitude, Trade for Skill", duration:"22 min", free:true,  desc:"Building your team from nothing, with the right alchemy." },
    { id:3, title:"Shoot the Beast", duration:"25 min", free:false, desc:"The moment you stop preparing and start filming." },
    { id:4, title:"Post-Production Survival Guide", duration:"30 min", free:false, desc:"From picture lock to final master on a shoestring." },
  ...
  "Mindset": [
    ...
    { id:8,  title:"The Growth Mindset in Practice", duration:"19 min", free:false, desc:"Fixed vs growth: identity-based habits that stick." },
  ...
  "Relationships": [
    ...
    { id:12, title:"Attachment Styles Explained", duration:"22 min", free:false, desc:"Anxious, avoidant, secure — and what to do about it." },
...
const sessions = [
  { id:1, name:"Discovery Session", meta:"60 min · Free", desc:"First conversation. We map where you are and where you want to go." },
  { id:2, name:"Filmmaking Strategy", meta:"90 min · €120", desc:"Script, budget, team, distribution. A full production roadmap for your project." },
  { id:3, name:"Mindset Coaching", meta:"60 min · €90", desc:"Limiting beliefs, growth habits, and a 30-day action plan." },
  { id:4, name:"Relationship Clarity", meta:"75 min · €100", desc:"Patterns, attachment styles, and a framework for what comes next." },
];
    ...
    <nav>
      ...
      <ul className="nav-links">
        {['Library','Booking','Contact'].map(p => (
          <li key={p}>
            <a onClick={() => setPage(p.toLowerCase())} style={{cursor:'pointer'}}>
              {p}
            </a>
          </li>
        ))}
  ...
  return (
    <section className="hero">
      ...
      <div className="hero-content">
        <div className="hero-eyebrow">Come Alive Vision · Vienna</div>
        <h1>
          Make it happen.<br />
        ...
        <div className="hero-actions">
          <button className="btn-primary" onClick={() => setPage('library')}>
            Explore Courses
          </button>
          <button className="btn-ghost" onClick={() => setPage('booking')}>
            Book a Session
          </button>
        </div>
      </div>
    ...
    <section className="about">
      <div className="about-grid max-w">
        ...
        <div className="about-text">
          ...
          <h2>Almost two decades of<br /><em>making things happen</em></h2>
          <p>
            Independent film producer, author, and coach based in Vienna. 
            I've produced films across Europe with no budget, entered Berlinale without an invitation,
            and walked into the Sacher Hotel looking for a free location for a car commercial — and got it.
          </p>
          <p>
            My work spans independent cinema, personal development, and relationship psychology.
            Six books. Hundreds of sessions. One consistent belief: the limitations are the opportunity,
            if you learn to work with them.
          </p>
          <p>
            This platform exists because I spent years recording content for other people's channels.
            It's time to build something of my own.
          </p>
          <div className="about-stats">
            <div className="stat">
              <div className="stat-num">20+</div>
              <div className="stat-label">Years in film & media</div>
            </div>
            <div className="stat">
            ...
            <div className="stat">
              ...
              <div className="stat-label">Pan-European network</div>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <section style={{background:'var(--ink)'}}>
      <div className="max-w text-center">
        ...
        <p style={{color:'var(--mist)', maxWidth:480, margin:'0 auto 0', fontSize:'0.9rem'}}>
        ...
        <div className="tiers-grid">
          <div className="tier-card">
            ...
            <ul className="tier-features">
              ...
              <li>Podcast access (Spotify)</li>
              <li>Newsletter & updates</li>
              <li>Community access</li>
            </ul>
            <button className="tier-btn tier-btn-outline" onClick={() => setPage('library')}>
              Start Free
            </button>
          </div>
          <div className="tier-card featured">
            <div className="tier-name">Creator</div>
            ...
            <ul className="tier-features">
              ...
              <li>Priority booking discount 20%</li>
              <li>Progress tracking dashboard</li>
            </ul>
            <button className="tier-btn tier-btn-filled">
              Join Creator — €29/mo
            </button>
            <div className="stripe-note">
              <strong>→ Stripe integration point.</strong> Connect your Stripe account here to process payments. Setup takes 15 minutes.
            </div>
          </div>
          <div className="tier-card">
            <div className="tier-name">Mastery</div>
            <div className="tier-price">€97 <span>/ month</span></div>
            <div className="tier-desc">Full access plus two 1-on-1 sessions per month.</div>
            <ul className="tier-features">
              <li>Everything in Creator</li>
              <li>2 × private coaching sessions</li>
              <li>Direct messaging access</li>
              <li>Custom growth roadmap</li>
              <li>Early access to new courses</li>
            </ul>
            <button className="tier-btn tier-btn-outline" onClick={() => setPage('booking')}>
              Apply for Mastery
            </button>
          </div>
        </div>
    ...
    <div className="library" style={{paddingTop:'6rem'}}>
      <div className="max-w" style={{padding:'0 3rem'}}>
        ...
        <p style={{color:'var(--mist)', marginBottom:'2.5rem', fontSize:'0.9rem', maxWidth:520}}>
          Free episodes marked clearly. Premium content unlocks with Creator membership.
        </p>
        <div className="course-tabs">
          {Object.keys(courses).map(tab => (
            <button key={tab} className={`course-tab ${activeTab===tab?'active':''}`}
        ...
        <div className="stripe-note" style={{margin:'3rem 0'}}>
          <strong>→ Vimeo integration point.</strong> Replace video-thumb divs with embedded Vimeo iframes. 
          Free videos: public Vimeo URLs. Premium videos: Vimeo private links, only served to authenticated Creator/Mastery members via Supabase auth check.
        </div>
      </div>
    </div>
  );
        ...
        <div className="booking-grid">
          <div>
            <p style={{color:'var(--mist)', fontSize:'0.88rem', marginBottom:'1.5rem'}}>
              Choose the session type that fits where you are right now.
              The Discovery call is always free.
            </p>
            <div className="session-types">
              {sessions.map((s,i) => (
                <div key={s.id} className={`session-type ${selected===i?'active':''}`}
          ...
          <div>
            {submitted ? (
              <div style={{padding:'3rem', border:'1px solid var(--border)', background:'var(--ink)', textAlign:'center'}}>
                <div style={{fontSize:'2rem', color:'var(--gold)', fontFamily:'Cormorant Garamond', marginBottom:'1rem'}}>
                  Request received.
                </div>
                <p style={{color:'var(--mist)', fontSize:'0.88rem'}}>
                  Angelo will be in touch within 24 hours to confirm your session.
                </p>
              </div>
            ) : (
              <div className="booking-form">
                ...
                <div className="form-group">
                  ...
                  <select className="form-select">
                    {sessions.map(s => <option key={s.id}>{s.name} — {s.meta}</option>)}
                  </select>
                </div>
                <div className="form-group">
                  <label className="form-label">Preferred Timezone</label>
                  <input className="form-input" type="text" placeholder="e.g. CET, GMT+1" />
                </div>
                <div className="form-group">
                  <label className="form-label">Tell me where you are</label>
                  <textarea className="form-textarea"
                    placeholder="What are you working on? Where are you stuck? What do you want to build?" />
                </div>
                ...
                <div className="stripe-note">
                  <strong>→ Calendly or Cal.com integration point.</strong> Replace this form with an embedded calendar for paid sessions. Free discovery call stays as a simple form to office@comealive.vision
                </div>
              </div>
            )}
          </div>
      ...
      <div className="max-w" style={{padding:'4rem 3rem'}}>
        ...
        <div className="contact-grid">
          <div className="contact-info">
            <p>
              Whether you have a question about the courses, want to collaborate
              on a film project, or just want to say hello — the door is open.
            </p>
            {[
          ...
          <div>
            {sent ? (
              <div style={{padding:'3rem', border:'1px solid var(--border)', textAlign:'center'}}>
                <div style={{fontFamily:'Cormorant Garamond', fontSize:'1.8rem', color:'var(--gold)', marginBottom:'1rem'}}>
                  Message sent.
                </div>
                <p style={{color:'var(--mist)', fontSize:'0.88rem'}}>
                  I'll reply within 48 hours. Usually much faster.
                </p>
              </div>
            ) : (
  ...
  return (
    <div className="dashboard">
      <div className="dash-header">
        ...
        <div style={{fontFamily:'DM Mono', fontSize:'0.65rem', color:'var(--mist)', letterSpacing:'0.1em'}}>
          Creator Plan · Active
        </div>
      </div>
            ...
            <>
              <div className="dash-cards">
                <div className="dash-card">
                  ...
                  <div className="dash-card-sub">of 18 total</div>
                  <div className="progress-bar"><div className="progress-fill" style={{width:'38%'}} /></div>
                </div>
                <div className="dash-card">
                  <div className="dash-card-label">Sessions Completed</div>
                  <div className="dash-card-value">2</div>
                  <div className="dash-card-sub">Next: April 7th</div>
                </div>
                <div className="dash-card">
                  <div className="dash-card-label">Membership</div>
                  <div className="dash-card-value" style={{fontSize:'1.4rem', marginTop:'0.3rem'}}>Creator</div>
                  <div className="dash-card-sub">Renews May 1st</div>
                </div>
              </div>
          ...
          {activeSection === 'sessions' && (
            <>
              ...
              <div style={{background:'var(--slate)', border:'1px solid var(--border)', padding:'1.8rem', marginBottom:'1rem'}}>
                <div style={{fontFamily:'Cormorant Garamond', fontSize:'1.2rem', color:'var(--parchment)', marginBottom:'0.4rem'}}>
                  Filmmaking Strategy Session
                </div>
                <div style={{fontFamily:'DM Mono', fontSize:'0.65rem', color:'var(--gold)', marginBottom:'0.8rem'}}>
                  April 7, 2026 · 14:00 CET · 90 min
                </div>
                <div style={{fontSize:'0.8rem', color:'var(--mist)'}}>Via Zoom · Link sent to email</div>
              </div>
              <div className="stripe-note">
                <strong>→ Calendly integration point.</strong> Embed your Calendly widget here so members can self-book directly from the dashboard without emailing you.
              </div>
            </>
          )}
            ...
            <>
              ...
              <div style={{padding:'3rem', border:'1px solid var(--border)', textAlign:'center'}}>
                ...
                <p style={{fontSize:'0.82rem', color:'var(--mist)'}}>
                  Mastery members can message Angelo directly here.
                </p>
              </div>
            </>
          )}
      ...
      {page === 'home' && (
        <>
          ...
          <section style={{background:'var(--slate)', padding:'5rem 3rem', textAlign:'center'}}>
            ...
            <h2>Shoot the Beast<br /><em>premieres April 5th</em></h2>
          ...
          <footer>
            <div className="footer-logo">Come Alive Vision</div>
            <div className="footer-links">
              {['Library','Booking','Contact'].map(l => (
                <a key={l} onClick={() => setPage(l.toLowerCase())} style={{cursor:'pointer'}}>{l}</a>
              ))}
            </div>
