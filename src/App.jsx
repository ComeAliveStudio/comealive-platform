...
const courses = {
  "Filmmaking": [
    { id:1,  title:"The Myth of the Budget",             duration:"18 min", free:true,  desc:"Why money is not the answer, and what to ask instead.", url:"https://player.vimeo.com/video/958087223?h=c3900df67f" },
      ...
      {page==='home' && (
        <>
          ...
          <section style={{background:'var(--slate)', padding:'5rem 3rem', textAlign:'center'}}>
            ...
            <p style={{color:'var(--mist)', maxWidth:460, margin:'0 auto 2rem', fontSize:'0.9rem'}}>The independent filmmaker's survival guide. New episodes every week on Spotify.</p>
            <button className="btn-primary">Follow on Spotify</button>
          </section>
          <footer>
            <div className="footer-logo">Come Alive Studio</div>
            <div className="footer-links">
              {['Library','Booking','Contact'].map(l => <a key={l} onClick={() => setPage(l.toLowerCase())}>{l}</a>)}
            </div>
